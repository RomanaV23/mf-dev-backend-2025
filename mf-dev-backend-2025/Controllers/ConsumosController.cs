...
namespace mf_dev_backend_2025.Controllers
{
    public class ConsumosController : Controller
    {
        ...
        {
            ViewData["VeículoId"] = new SelectList(_context.Veiculos, "Id", "Nome");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricao,Data,Valor,Km,Tipo,VeículoId")] Consumo consumo)
        {
            ...
            ViewData["VeículoId"] = new SelectList(_context.Veiculos, "Id", "Nome", consumo.VeículoId);
            return View(consumo);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descricao,Data,Valor,Km,Tipo,VeículoId")] Consumo consumo)
        {
            if (id != consumo.Id)
            {
                return NotFound();
